...
export interface InstitutionReviewsProps {
...
export default function InstitutionReviews({ institutionId, reviews, reviewsLoading, user }: InstitutionReviewsProps) {
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                  ...
                  <div>
                    ...
                    <div style={{ fontSize: 12, color: 'var(--fg3)' }}>
                      {r.created_at ? new Date(r.created_at).toLocaleDateString('es-MX', { month: 'long', year: 'numeric' }) : ''}
                    </div>
                  </div>
                </div>
