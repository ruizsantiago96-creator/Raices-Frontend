...
import { IdentityStatusCard } from '@features/profile/components/IdentityStatusCard'
...
export default function MiIdentidadPage() {
  ...
  const config = IdentityStatusCard?.useIdentityStatusConfig ? IdentityStatusCard.useIdentityStatusConfig(estado) : { label: '', color: '', bg: '', description: '', icon: Icons.upload }
