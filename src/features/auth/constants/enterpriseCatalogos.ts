...
export const ENTERPRISE_SUBTYPES = [
  { id: 'institucion_apoyo', label: 'Institución de apoyo', desc: 'Organizaciones que brindan servicios de acompañamiento', icon: FluentEmoji.apoyo },
  { id: 'escuela_publica', label: 'Escuela pública', desc: 'Instituciones educativas públicas inclusivas', icon: FluentEmoji.escuelaPublica },
  { id: 'escuela_privada', label: 'Escuela privada', desc: 'Instituciones educativas privadas con programas inclusivos', icon: FluentEmoji.escuelaPrivada },
  { id: 'centro_terapeutico', label: 'Centro terapéutico', desc: 'Centros especializados en terapia y rehabilitación', icon: FluentEmoji.centroTerapeutico },
  { id: 'especialista', label: 'Especialista', desc: 'Profesionales independientes (terapeutas, psicólogos, etc.)', icon: FluentEmoji.especialista },
]
...
export const COMMUNITIES = [
  { id: 'pcd', label: 'Personas con discapacidad', desc: 'Conectar directamente con quienes buscan apoyo', icon: FluentEmoji.pcd },
  { id: 'familias', label: 'Familias y cuidadores', desc: 'Apoyar a las familias que acompañan a una persona PCD', icon: '👨‍👩‍👧‍👦' },
  { id: 'profesionales', label: 'Profesionales y especialistas', desc: 'Conectar con otros expertos del campo', icon: FluentEmoji.especialista },
  { id: 'instituciones', label: 'Otras instituciones', desc: 'Colaborar con gobiernos, ONGs y fundaciones', icon: FluentEmoji.gobierno },
