...
export function DirectMessages({
  ...
  const [activeNewPartner, setActiveNewPartner] = useState<MessagePartner | null>(null)
    ...
    >
            ...
            filteredConversations.map(conv => {
              ...
              return (
                <button
                  ...
                  onMouseEnter={e => {
                    if (!isSelected) e.currentTarget.style.background = 'rgba(7, 59, 76, 0.04)'
                  }}
                  onMouseLeave={e => {
      ...
      {activePartnerId ? (
        <div style={{ display: 'flex', flexDirection: 'column', background: 'var(--bg-surface)' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 14, color: 'var(--fg3)' }}>
              {isFloating ? (
                <>
                  ...
                  <button
                    onClick={() => setFloatingChatMaximized(!floatingChatMaximized)}
                    title={floatingChatMaximized ? 'Restaurar' : 'Maximizar'}
                    style={{
                      background: 'none',
                      border: 'none',
                      cursor: 'pointer',
          ...
          >
            {messages.map(msg => {
              const mine = String(msg.from_id) === String(currentUserId)
              ...
              >
                ...
                <label
                  ...
                  style={{
                    ...
                    border: 'none',
                    cursor: 'pointer',
                    color: pendingFile ? 'var(--primary)' : 'var(--fg3)',
                    padding: 4,
                    display: 'flex',
                    alignItems: 'center',
                  }}
  ...
  return (
    <main className="responsive-main" style={{ ['--main-max-width' as string]: '1060px' }}>
      ...
      <div className="animate-fade-in-up delay-1">
        <DirectMessages currentUserId={user?.id !== undefined ? String(user.id) : undefined} />
      </div>
    </main>
  )
}
