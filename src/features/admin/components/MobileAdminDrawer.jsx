...
export default function MobileAdminDrawer({ isOpen, onClose, tab, onTab, pendingCount, criticalCount }) {
  const NAV = [
    { key: 'overview', label: 'Inicio', icon: Icons.home },
    { key: 'intelligence', label: 'Inteligencia', icon: Icons.brain },
    { key: 'institutions', label: 'Instituciones', icon: Icons.building, badge: pendingCount },
